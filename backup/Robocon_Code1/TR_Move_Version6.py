    ...
    for i in range(len(rx)-1):
        if((rx[i] == rx[i+1]) | (ry[i] == ry[i+1])):
            if(ry[i] == ry[i+1]):
                ...
                if (i == (len(rx)-2)):
                    if right>0:
                        mr.cubic_Polynominal(startx, rx[i+1], ry[i], ry[i+1], right, 0, 0, 0, 0, 0)
                        right = 0
                        continue
                    
                    elif left>0:
                        mr.cubic_Polynominal(startx, rx[i+1], ry[i], ry[i+1], left, 0, 0, 0, 0, 0)
                        left = 0
                        continue 
            ...
            if(rx[i] > rx[i+1]):
                ...
                if (i == (len(rx)-2)):
                    if leftdown>0:
                        mr.cubic_Polynominal(startx, rx[i+1], starty, ry[i+1], math.sqrt(2*(leftdown**2)), 0, 0, 0, 0, 0)
                        leftdown=0
                    elif leftup>0:
                        mr.cubic_Polynominal(startx, rx[i+1], starty, ry[i+1], math.sqrt(2*(leftup**2)), 0, 0, 0, 0, 0)
                        leftup = 0
            ...
            #move rightup and rightdown
                ...
                if(i == (len(rx)-2)):
                    if rightdown>0:
                        mr.cubic_Polynominal(startx, rx[i+1], starty, ry[i+1], math.sqrt(2*(rightdown**2)), 0, 0, 0, 0, 0)
                        rightdown =0
                    elif rightup>0:
                        mr.cubic_Polynominal(startx, rx[i+1], starty, ry[i+1], math.sqrt(2*(rightup**2)), 0, 0, 0, 0, 0)
                        rightup=0
